...
#Yakit hesaplama icin yazilan programin hesapla butonunu kaldirip yerine degerler girilirken hesaplama yapilmasini saglamak
class yakitHesaplayicisi(QDialog):
    def __init__(self,ebeveyn=None):
        ...
        self.connect(self.gidilenYol, SIGNAL('textChanged(QString)'), self.yakitHesapla)
        ...
        self.connect(self.yakitFiyati, SIGNAL('textChanged(QString)'), self.yakitHesapla)
        ...
        self.connect(self.yakitTuketimi, SIGNAL('textChanged(QString)'), self.yakitHesapla)
